...
class ItemListActivity : AppCompatActivity() {
    ...
    private fun showAddItemDialog() {
        ...
        dialogBuilder.setTitle(getString(R.string.add_perish_item))
    ...
    fun showEditItemDialog(curName: String, curDate: String, position: Int) {
        val dialogBuilder = AlertDialog.Builder(this)
        dialogBuilder.setTitle("Edit perishable item")
        ...
        dialog.etName.setText(curName)
        dialog.etDate.setText(curDate)
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
            ...
            itemRecyclerAdapter.editItem(name, expireDate, position)
